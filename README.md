...
## Key Notes
JS, HTML, CSS and data files are found in the folder "D3_data_journalism".
For best performance, run python -m http.server in GitBash and on localhost:8000 in an incognito window in Chrome.
